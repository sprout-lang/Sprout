...
export type Statement = LetStatement | AssignmentStatement | ListenStatement | SetStatement | AddStatement | ToggleStatement | SendStatement | TemplateStatement | BindStatement | CallJsStatement | IfStatement | ForStatement | ExpressionStatement;
...
export type Expression = IdentifierExpression | LiteralExpression | BinaryExpression | LogicalExpression | UnaryExpression | CallExpression | MemberExpression | ListExpression | MapExpression | LambdaExpression | RenderExpression | GetExpression | GroupExpression;
